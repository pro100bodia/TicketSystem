...
public class JpaListUserModelRepositoryTest {
    ...
    @InjectMocks
    private JpaListUserModelRepository subject;
    ...
    public void givenNoArgs_whenFindAll_ThenReturnUserModels() {
        ...
        for (int i = 0; i < userModels.size(); i++) {
            when(modelMapper.map(users.get(i), UserModel.class)).thenReturn(userModels.get(i));
        }
